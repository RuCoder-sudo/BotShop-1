...
class Database:
    ...
    def create_order(self, order_number: str, buyer_id: int, seller_id: int,
                    product_id: int, quantity: int, total_price: float,
                    payment_method: str, delivery_address: str, phone: str):
        cursor = self.conn.cursor()
        cursor.execute('''INSERT INTO orders 
                     (order_number, buyer_id, seller_id, product_id, quantity,
                      total_price, payment_method, delivery_address, phone, created_at)
                     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)''',
                     (order_number, buyer_id, seller_id, product_id, quantity,
                      total_price, payment_method, delivery_address, phone,
